...
단순히 스텝을 기록하는 것 말고도 코드블록을 스텝에 기록한다거나 [쉘 명령]("https://github.com/microsoft/codetour?tab=readme-ov-file#shell-commands")을 입력하여 실행할 수도 있는 것 같았다.
